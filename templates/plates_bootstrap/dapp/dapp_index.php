    ...
    <main id="MainSection" class="mx-auto h-full max-w-7xl pt-24 md:pt-12 px-4 md:px-8" role="main" data-urlbaseaddr="<?=$view['urlbaseaddr'] ?>">
        ...
        <div id="accountStatus" class="account-btn">
            <div class="row" style="padding: 0 15px;">
                ...
                <div class="col-md-6">
                    <div id="currentAccount" class="cta">
                        0x0000...0000
                    </div>
                </div>
                <div class="col-md-3">
                    <div id="currentNetworkLogo" class="wallet-icon cta" style="mix-blend-mode: normal; filter: none; padding: 0 5px;">
            ...
            <ul class="balances">
                <li>Balance<span id="balanceInfo">0.00</span></li>
                <li>WNat<span id="wnatInfo">0.00</span></li>
                <li>P-Balance<span id="pBalanceInfo">0.00</span></li>
            </ul>
