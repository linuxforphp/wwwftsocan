...
export var flrAddr = selectedNetwork?.options[selectedNetwork.selectedIndex].getAttribute('data-registrycontract');
export var rpcUrl = selectedNetwork?.options[selectedNetwork.selectedIndex].getAttribute('data-rpcurl');
export var chainidhex = selectedNetwork?.options[selectedNetwork.selectedIndex].getAttribute('data-chainidhex');
export var networkValue = selectedNetwork?.options[selectedNetwork.selectedIndex].value;
export var tokenIdentifier = selectedNetwork?.options[selectedNetwork.selectedIndex].innerHTML;
...
export async function GetContract(ContractName) {
    var RPC = document.getElementById("SelectedNetwork")?.options[document.getElementById("SelectedNetwork").selectedIndex].getAttribute('data-rpcurl');
